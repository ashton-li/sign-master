<template>
  <PageShell :tab="false" compact>
    ...
    <view class="feedback soft-card">
      ...
      <button :disabled="!feedback.trim()" @click="handleCopyFeedback">复制反馈内容</button>
    </view>
  </PageShell>
</template>
...
const faqs = [
  ...
  { q:'没有识别到签字位怎么办？', a:'签字位识别为实验性功能。可跳过识别，手动添加位置，或在文件上长按后选择手写签字或已有签字。' },
