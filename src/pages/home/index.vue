<template>
  <PageShell active="home">
    ...
    <view v-else :class="['home-empty',{ guided:firstUse }]">
      <view class="empty-pulse"><view class="empty-doc"><SvgIcon name="sign" :size="31" /></view></view>
