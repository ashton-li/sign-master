  ...
  <PageShell :tab="false" :compact="stage !== 'source'">
    <template v-if="stage === 'source'">
      <view class="source-heading">
        ...
        <!-- #ifdef MP-WEIXIN -->
        <text class="experimental-note">签字位识别为实验性功能，当前版本选择文件后直接手写签字</text>
        <!-- #endif -->
      </view>
...
.experimental-note{display:block;margin-top:7px;padding:6px 8px;color:#875812;font-size:9px;line-height:14px;border-radius:6px;background:#fff5dc}
